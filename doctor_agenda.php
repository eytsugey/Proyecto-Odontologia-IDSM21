...
function enviarWhatsApp(telefono, paciente, fecha, hora, tipo){
    ...
    switch(tipo){
        ...
        case 'reprogramada':
            ...
            mensaje = `Hola ${paciente}, tu cita ha sido REPROGRAMADA ⏳.\nNueva fecha: ${nuevaFecha} a las ${nuevaHora}.`;
        break;

        default:
            alert("❌ Tipo de mensaje inválido");
            return;
    }

    // Codificar correctamente (muy importante)
    let mensajeCodificado = encodeURIComponent(mensaje);

    let url = `https://wa.me/${telefono}?text=${mensajeCodificado}`;

    // Confirmación antes de abrir WhatsApp
    if(confirm("¿Enviar mensaje por WhatsApp?")){
