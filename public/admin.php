...
<section class="panel">
  ...
  <div class="quick-links">
    ...
    <?php if ($rolActual === 'admin'): ?>
      ...
      <a class="quick-link-card" href="plan_tratamiento.php"><strong>Plan de tratamiento</strong><span>Organiza el plan general del paciente con tratamientos y estimado.</span></a>
